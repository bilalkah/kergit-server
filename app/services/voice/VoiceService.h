...
class VoiceService {
   public:
    ...
    std::optional<ResumeTransferResult> try_resume_voice_ownership(
        const UserId& user, const HubId& hub, const ChannelId& channel,
        std::string_view resume_id, SessionId next_owner_session);
