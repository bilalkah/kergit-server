...
void Dispatcher::register_all() {
    ...
    map_proto_[sercom::protocol::Envelope_Type_REQUEST_STATE_SYNC] =
        std::make_unique<RequestStateSyncCommand>();
    ...
    map_proto_[sercom::protocol::Envelope_Type_VOICE_KICK_PARTICIPANT] =
        std::make_unique<KickVoiceParticipantCommand>();
    ...
    map_proto_[sercom::protocol::Envelope_Type_HUB_INVITE_VALIDATE] =
        std::make_unique<ValidateHubInviteCommand>();
    ...
    map_proto_[sercom::protocol::Envelope_Type_HUB_MEMBER_KICK] =
        std::make_unique<KickHubMemberCommand>();
    map_proto_[sercom::protocol::Envelope_Type_HUB_UPDATE] = std::make_unique<UpdateHubCommand>();
    map_proto_[sercom::protocol::Envelope_Type_HUB_MEMBER_ROLE_UPDATE] =
        std::make_unique<UpdateHubMemberRoleCommand>();
