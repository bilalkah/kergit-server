...
bool ChatClient::connect() { return pImpl->app.connect(); }

void ChatClient::disconnect() { pImpl->app.disconnect(); }

void ChatClient::reset() { pImpl->app.reset(); }

bool ChatClient::is_connected() const { return pImpl->app.is_connected(); }
...
bool ChatClient::leave_channel() { return pImpl->app.leave_channel(); }

bool ChatClient::send_message(const std::string& text) { return pImpl->app.send_message(text); }

bool ChatClient::list_channels() { return pImpl->app.list_channels(); }

bool ChatClient::list_users() { return pImpl->app.list_users(); }

bool ChatClient::ping() { return pImpl->app.ping(); }
...
std::string ChatClient::get_username() const { return pImpl->app.get_username(); }

std::string ChatClient::get_current_channel() const { return pImpl->app.get_current_channel(); }
