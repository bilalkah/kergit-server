...
class NetworkStack : utils::Loggable {
   public:
    ...
    void attach_online_user_count_provider(
        transport::websocket::TextWSServer::OnlineUsersProvider provider);
    void attach_active_webrtc_user_count_provider(
   ...
   private:
    ...
    transport::websocket::TextWSServer::OnlineUsersProvider online_user_count_provider_{};
    transport::websocket::TextWSServer::ActiveWebRtcUsersProvider active_webrtc_user_count_provider_{};
