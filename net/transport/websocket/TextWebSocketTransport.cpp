        ...
        cfg_.ws_path,
        {
            ...
            .open =
                [this](UwsSocket* ws) {
                    ...
                    app::queue::ConnectionEvent ev{psd->conn_id};
                    event_queue_.push(app::queue::Event{ev});
            ...
            .message =
                [this](UwsSocket* ws, std::string_view data, uWS::OpCode op) {
                    ...
                    app::queue::MessageEvent ev{psd->conn_id,
                                                app::queue::Payload{std::string{data}}};
                    event_queue_.push(app::queue::Event{ev});
                },
            .drain =
                [](UwsSocket* /*ws*/) {
            ...
            .close =
                [this](UwsSocket* ws, int code, std::string_view reason) {
                    ...
                    app::queue::DisconnectionEvent ev{conn_id, code, std::string(reason)};
                    event_queue_.push(app::queue::Event{ev});
                },
        });
